export const Tickets = ({ send, context }) => {
  ...
  return (
    <div className="flex flex-col bg-white min-w-[300px]  max-w-md rounded-3xl drop-shadow-lg p-5">
      ...
      <div id="toast-simple" className="flex items-center w-full max-w-xs p-4 space-x-4 text-gray-900 bg-gray-50 divide-x  rounded-lg shadow border border-gray-600 divide-gray-700 space-x">
    ...
    <div className="pl-4 text-sm font-normal">Colombia</div>
  </div>
